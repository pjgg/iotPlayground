...
func NewHTTPIotRegistryConnector(protocol connectors.Protocol, projectID string, region string) HTTPIotRegistryConnectorInterface {

	onceRegistry.Do(func() {
		ctx := context.Background()

		if protocol == connectors.HTTP {
